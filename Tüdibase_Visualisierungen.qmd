...
plot_informativity <- data_w |> 
 ...
 ggplot(aes(infor, group)) +
    ...
    xlab("Experimetal Bedingungen") +
    ylab("Wahrgenommene Informativität")
...
plot_diff_am <- data_w  |> 
  ...
  ggplot(aes(diff_am, group)) +
    ...
    labs(title = "Akkuratheit (Abstrakte Metrik)",
         ...
         caption = "Mittelwert ± 1*SD") + 
    xlab("Experimetal Bedingungen") +
    ylab("Differenzvariable: Interpretation (in abstrakter Metrik)")
...
plot_diff_u3 <- data_w  |> 
  ...
  ggplot(aes(diff_u3, group)) +
    ...
    labs(title = "Akkuratheit (Cohen's U3)",
         ...
         caption = "Mittelwert ± 1*SD") + 
    xlab("Experimetal Bedingungen") +
    ylab("Differenzvariable: Interpretationen (in Cohen's U3)")
...
plot_u3_misconceptions <- data_w |> 
    ...
    mutate(group = recode_factor(group,
                  ...
                  `eg_signaling_overlap` = "Signaling Overlap\nN=57",
                  `eg_signaling_u3` = "Signaling Cohen's U3\nN=53"),
           rating_u3_misconcept = as.factor(rating_u3_misconcept),
           'U3 Fehlkonzept' = recode(rating_u3_misconcept,
                                            `FALSE` = "kein U3-Fehlkonzept",
                                            `TRUE` = "U3-Fehlkonzept vorhanden")) |>  
    na.omit() |> 
    distinct() |> 
    ggplot(aes(group, 
               fill = 'U3 Fehlkonzept'
    ...
    labs(title = "Häufigkeit an Cohen's U3-Fehlkonzepten",
         subtitle = "per Experimentalbedingung") + 
    xlab("Experimetal Bedingungen") +
    ylab("Anzahl an (nicht) vorhanden Cohen's U3-Fehlkonzepten")
