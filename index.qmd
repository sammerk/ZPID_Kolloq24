...
| {{< iconify fa6-solid mdi:text-box-outline >}} | Studie 1: Trennung Effektstärken und Inferenzstatistik   |
| {{< iconify fa6-solid mdi:graph-box-outline >}}   | Studie 2: Grafische Kommuniaktion von Effektstärken   |
| {{< iconify fa6-solid mdi:text-box-outline >}} + {{< iconify fa6-solid mdi:graph-box-outline >}}   | Studie 3: Grafische & verbale Kommunikation von Effektstärken   |
