...
- Berücksichtigen von Forschungsergebnissen im professionellen Handeln ist eine Anforderung an verschiedene Berufsgruppen wie Mediziner:innen, Politiker:innen, Psycholog:innen oder Lehrpersonen [z.B. @sackett1996; @bauer2023; @APA2006]
...
- häufig Aufbereitung quantitativer Studien, die verschiedene quantitativ-methodische Informationen (z.B. Studiendesign, Inferenzstatistik, Effektstärken) enthalten
- Effektstärken informieren über die Größe eines Effekts
  - ergänzendes oder alternatives Maß zu statistischer Signifikanz und p Werten, um zahlreichen empirisch belegten Fehlkonzepten bezüglich statistischer Signifikanz und p Werten [@haller2002; @kühberger2015; @sotos2009] entgegen zu wirken [@coe2002; @kelley2012; @cumming2014]
  - Grundlage, um die praktische Relevanz wissenschaftlicher Ergebnisse abzuleiten [@baird2019; @kelley2012; @kraft2020] 
  - textliche und visuelle Aufbereitung möglich 


## Kommunikation von Effektstärken {{< iconify fa6-solid ant-design:comment-outlined >}} {.smaller}

- verschiedene textliche und visuelle Darstellungen können die Interpretation und Wahrnehumg von Effektstärken bei wissenschaftlichen Laien beeinflussen kann [@hanel2019; @lortie2021; @kim2022; @merk2023; @kale2021]
- kaum konsistenten Ergebnisse
  - unterschiedliche Vergleichsbedingungen 
  - unterschiedliche Operationalisierungen
...
- grundsätzlich zeigen experimentelle Studien aus unterschiedlichen Forschungsbereichen (z.B. Psychologie, Informatik, Bildungswissenschaften), dass verschiedene textliche und visuelle Darstellungen die Interpretation und Wahrnehumg von wissenschaftlichen Laien beeinflussen kann
