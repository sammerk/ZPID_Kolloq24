...
- Berücksichtigen von Forschungsergebnissen im professionellen Handeln als Anforderung an verschiedene Berufsfelder/Berufgsgruppen wie Mediziner:innen, Politiker:innen, Psycholog:innen oder Lehrpersonen [z.B. @sackett1996; @bauer2023; @APA2006]
...
- nutzerfreundliche Aufbereitung von Evidenz (z.B. clearing houses, plain language summaries), um den Umgang mit Evidenz zu erleichern [@wadhwa2024; @higgins2022; @kerwer2021]
- häufig quantitative Studien, die verschiedene quantitativ-methodische Informationen (z.B. Studiendesign, Inferenzstatistik, Effektstärken) enthalten
Studiendesign
- Effektstärken informieren über die Größe eines Effekts
  - ergänzendes oder alternative Maßes zu statistischer Signifikanz und p Werten, um zahlreichen empirisch belegte Fehlkonzepte bezüglich statistischer Signifikanz und p Werten [@haller2002; @kühberger2015; @sotos2009] entgegen zu wirken [@coe2002; @kelley2012; @cumming2014]
...
<center> {{< iconify fa6-solid nimbus:exclamation-triangle >}} inkonsistente Ergebnisse, welche statistischen Formulierungen und Effektstärkenvisualisierungen sich für eine informative und verständliche Wissenschaftskommunikation eignen {{< iconify fa6-solid nimbus:exclamation-triangle >}} </center>

- grundsätzlich zeigen empirische Belege, dass die Interpretation und Wahrnehumg von wissenschaftlichen Laien beeinflusst werden kann
- experimentelle Studien verwenden unterschiedliche textliche und visuelle Darstellungen --> Vergleichbarkeit der Ergebnisse erschwert 

__textliche Aufbereitung von Effektstärken:__

- wissenschaftliche Laien schätzen die gängige Signifikanz-Aussage und Cohen's *U<sub>3</sub>* informativer ein als andere Statistiken wie Cohen's *d* oder Bayes Faktoren [@hanel2019]
...
- wissenschaftliche Laien interpretieren Effektstärken akkurater, wenn probability of superiority and Effektstäken Analogien verwendet wurden im Vergleich zu Mittelwertsdifferenzen oder Konfidenzintervalle
  
__visuelle Aufbereitung von Effektstärken:__
  
- Lehrpersonen interpretieren Effektstärkenvisualisierungen (z.B. stacked bar plots) mit hoher Akkuratheit, wenn eine Vergleichsgrafik mit einer Information wie Statistiker:innen den präsentierten Effekt beschreiben würden [@merk2023]
- identische Effektstärken werden in Abhängigkeit der Darstellung unterschiedlich rezipiert (Merk et al., 2023)
- outcome uncertainty/variability wirkt sich positiv auf die Interpretation aus, wohingegen die Darstellung von Mittelwerten zu Fehlinterpretationen führen kann
- Diskrepanz ziwschen Visualisierungen die die akkurate Interpretation und die korrekte Entscheidungsfindung fördern (Kale et al. 2021)
...
- Lehrpersonen erhielten zunächst eine Studienvignette zu einem bildungswissenschaftlichen Thema, zufällig aus 4 verschiedenen Themen ausgewählt
  - hier Beispiel: Videoanleitung mit und ohne Untertitel
...
- nach jeder Visualisierung verschiedene Fragen gestellt
  - Verständnis wurde zufällig nach den ersten 12 oder letzten 12 Visualisierung mit folgenden drei Fragen operationalisiert. Aber heute nur zwei relevant:
