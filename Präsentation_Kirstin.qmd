...
::: notes
- grundsätzlich verschiedene Berufsgruppen wie Mediziner:inen, Politiker:innen, Psycholog:innen oder Lehrpersonen dazu angehalten Evidenz, also aufbereitete Forschungsergebnisse, in ihrem professionellen Handeln zu berücksichtigen 
- über die verschiedenen Berufsgruppen hinweg, bedeutet das immer die entsprechende vorhandene Evidenz als eine Informationsquelle zu nutzen, die aber auch mit der eigenen praktischen Expertise verknüpft wird
- Fokus im heutigen Vortrag: Lehrpersonen
...
- aber wir wollen nicht nur eine secondhand evaluation, also die Bewertung der Glaubwürdigkeit und Vertrauenswürdigkeit der Quelle, sondern, dass sie selbst in der Lage sind die Informationen zu bewerten
...
::: notes
- die Idee ist, dass nutzerfreundliche Aufbereitung Forschungsergebnisse verständlich, dennoch akkurat und trotzdem praktisch relevant präsentieren, um wissenschaftlichen Laien wie Lehrpersonen den Umgang 
- Beispiele hierfür sind die immer prominentere werden Ansatz von Clearinghouses, aber auch Ansätze wie plain language summaries
...
- aus methodischer Sicht kann man z.B. sagen, dass Effektstärken verstärkt vorgeschlagen wurden und werden, vor allem als Ergänzung Nullhypothesen Signifikanz tests, um bekannte und empirisch gut belegte Fehlkonzepte von statistischer Signifikant und p Werten zu reduzieren 
- Kombi wird mittlerweile auch als best practice angesehen 
- mit Blick auf das professionelle Handeln bieten Effektstärken auch eine Grundlage, um überhaupt die praktische Relevanz wissenschaftlicher Ergebnisse abzuleiten -> zwar nicht hinreichend aber eine zentrale Bedingung

- Effektstärken können sowohl textlich als auf visuell aufbereitet werden 
- als ersten Eindruck - ohne nähere darauf einzugehen ä- Beispiele aus Clearing Houses im Bildungsbereich aus DE mitgebracht
...
- erste empirische und experimentelle Forschung aus ganz verschiedenen Disziplinen - -  zur Kommunikation von Effektstärken vorhanden
- diese zeigen, dass unterschiedliche Formate sowohl textlich als auch visuell die Wahrnehmung also z.B. wie informativ eine Aufbereitung wahrgenommen wird und das Verständnis - wie akkurat die Effektstärke interpretiert wird 
- der Forschungsstand setzt sich aus Forschung verschiedener Disziplinen zusammen z.B. Psychologie, Informatik, Bildungswissenschaften, ist in seiner Anlage häufig eklektisch und es zeigen sich teilweise inkonsistente Ergebnisse
- weshalb nur kurz aus der Metaperspektive zusammengefasst:
  - unterschiedliche Bedingungen: Cohen's U3 
  - unterschiedliche Operationalisierungen von AV und UV 
- Vergleichbarkeit schwierig und keine eindeutige Tendenz, was grundsätzlich gut eignet
...
- Daher in den folgenden Studien sowohl Formulierungen als auch Visualisierungen in den Blick genommen
...
::: notes
- nicht ausführlich auf die Studie eingehen, aber Ihnen kurz zeigen, dass wir sowohl bei den Lehrpersonen, die statistische Signifikanz interpretierten als auch bei denjenigen, die Cohen's U3 interprtetierten 4 Profile fanden, die über beide Substichproben vergleichbar waren
...
- genau entgegen der korrekten Interpretation - misconceptualizers 
- ein Profil mit nur wenig Personen unterschied sich bei beiden Gruppen: einmal eher verneint, dass U3 eine Aussage über Effektsicherheit und -größe bietet (refuters) und einmal die Mitte gewählt, was wir als die Unschlüssigen - indecisives bezeichnet haben
:::
...
- ausgehend davon, dass halfeye plots -sowohl mit Gruppen auf x als auch y-Achse- am informativsten eingeschätzt wurden, und kaum Unterschiede in Akkuratheit zwischen den Visualisierungsarten zu finden waren
...
## {.em08 background-iframe="https://graphs-2t-demo.formr.org" background-interactive="true"}
...
- nach jeder Visualisierung verschiedene Fragen gestellt
  ...
  - wie informativ sie die Information in der Visualisierung fanden - 7stufige Likertskala
...
- hier wurden nur Personen eingeschlossen, die grundsätzlich im Median plausible U3 Ratings angaben (- U3 Fehlkonzept: Median des U3 Ratings kleiner als 21.2% (kleinster plausibler Wert, der d = −.8 entspricht) -> n = XXX) 

- Bayesianische Mehrebenenanalysen moderate bis starke Evidenz für keinen Unterschied zwischen signaling und Kontrollgruppe und benchmarking und Kontrollgruppe

- Schaut man sich nur die Ergebnisse derjenigen ohne Fehlkonzept an, zwar weiterhin keine substanziellen Unterschiede zwischen den Visualisierungen, aber akkuratere Interpretationen; Bayesianische Analysen sprechen ebenfalls für die Nullhypothese
...
- Fehlkonzepte in U3 (n = 22), denn es gibt Personen, die konsequent unplausible U3-Werte angeben
